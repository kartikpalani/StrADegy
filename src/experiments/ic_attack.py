...
from attack_models.ic_model import IndependentCascadeModel
...
def main():
	...
	for _ in range(simulation_count):
	  ...
	  attack = IndependentCascadeModel(G,source)
	  compromised_this_attack = attack.diffuse()
	  print "The set of nodes compromised this attack are: {}".format(compromised_this_attack)
